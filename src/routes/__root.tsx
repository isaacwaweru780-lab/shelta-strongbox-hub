...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        title: "Shelta Packaging Ltd — Strong Packaging. Solid Partnerships.",
      },
      {
        name: "description",
        content:
          "Shelta Packaging Ltd manufactures durable corrugated cartons, die-cut boxes, horticulture packaging and industrial cartons in Ruiru, Kenya.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Manufacturer of corrugated carton packaging solutions in Kenya.",
          address: {
            "@type": "PostalAddress",
            streetAddress: "Ruiru – Mugutha, near Mugutha Police Station",
            addressRegion: "Kiambu County",
            addressCountry: "KE",
          },
          telephone: "+254720440580",
