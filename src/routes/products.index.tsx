...
export const Route = createFileRoute("/products/")({
  head: () => ({
    meta: [
      { title: "Products — Shelta Packaging Ltd" },
      {
        name: "description",
        content:
          "Explore Shelta Packaging's full range: corrugated cartons, RSC, horticulture boxes, die-cut, kraft paper, industrial packaging, trays and dividers.",
      },
      { property: "og:title", content: "Products — Shelta Packaging Ltd" },
      {
        property: "og:description",
        content: "Corrugated cartons, die-cut boxes, horticulture boxes, kraft paper and more.",
      },
